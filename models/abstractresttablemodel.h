...
public:
    ...
    void registerCalcColumn(CalcColumn* column);
    ...
    virtual bool tryToSubmit(qlonglong id) = 0;
    ...
    int colIdxByName(QString name) const;
...
class CalcColumn {
public:
    CalcColumn(QString name);
    void setModel(AbstractRestTableModel* model);
protected:
    QVariant modelData(int row, QString field, int role);

    AbstractRestTableModel* _model;
    QString _name;
};

/** Lockup column */
class LookupJsonColumn : public CalcColumn {
public:
    LookupJsonColumn(QString name, AbstractRestTableModel* lookupModel, QString keyColumn, QString lookupColumn);

    // AbstractJsonColumn interface
public:
    QVariant data(int row, int role, const QJsonObject &jObj) const;
protected:
    AbstractRestTableModel* _lookupModel;
    QString _keyColumn;
