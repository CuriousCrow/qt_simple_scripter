...
TableHighlighter::TableHighlighter(QObject *parent) :
    QSyntaxHighlighter(parent)
{
}

void TableHighlighter::setEnabled(bool value)
{
...
void TableHighlighter::highlightBlock(const QString &text)
{
